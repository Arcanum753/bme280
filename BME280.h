...
#define I2C_INSTANCE_1 hi2c1 //3v
// something magic
#define BME280_UNKNOWN_FLOAT	0.000750061683f
#define BME280_UNKNOWN_MASK 	0x09
...
//------------------------------------------------
#define BME280_ADDRESS (0x76<<1)//0xEC //BME280 I2C ADDRES (0x76<<1)
